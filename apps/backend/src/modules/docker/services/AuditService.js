...
export const findAudit = async function (id) {
...
export const fetchAudit = async function () {
    return new Promise((resolve, reject) => {
...
export const paginateAudit = function ( pageNumber = 1, itemsPerPage = 5, search = null, filters = null, orderBy = null, orderDesc = false) {
...
export const createAudit = async function (authUser, {user, action, target}) {
...
export const updateAudit = async function (authUser, id, {user, action, target}) {
    return new Promise((resolve, rejects) => {
...
export const deleteAudit = function (id) {
    return new Promise((resolve, rejects) => {
